...
public class MoviesAdapter extends RecyclerView.Adapter<MoviesAdapter.MovieViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final MovieViewHolder movieViewHolder, int i) {
        ...
        movieViewHolder.bindMovie(mMovies.get(i));

        movieViewHolder.setOnItemClickedListenerListener(new OnItemClickedListener() {
            @Override
            public void onMovieClicked(View v, int position, boolean isLongClick) {
                if (isLongClick) {
                    ...
                    Toast.makeText(mContext, "ShortClick: " + position + String.valueOf(
                            mMovies.get(position).getId()), Toast.LENGTH_SHORT).show();

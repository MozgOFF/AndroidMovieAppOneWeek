...
public class RecommendationsAdapter extends RecyclerView.Adapter<RecommendationsAdapter.RecommendationsViewHolder> {
    ...
    public RecommendationsAdapter(Context mContext) {
    ...
    @NonNull
    @Override
    public RecommendationsAdapter.RecommendationsViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final RecommendationsViewHolder recommendationsViewHolder, int i) {
        Log.d(TAG, "onBindViewHolder is called");

        recommendationsViewHolder.bindMovie(mMovies.get(i));

        recommendationsViewHolder.setOnItemClickedListenerListener(new OnItemClickedListener() {
            @Override
    ...
    public class RecommendationsViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener{

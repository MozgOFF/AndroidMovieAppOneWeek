...
public class FragmentTopRated extends Fragment implements MoviesLoader.MovieLoadCallback {

    private MoviesLoader mLoader;
    private RecyclerView mMoviesView;
    private MoviesAdapter mMoviesAdapter;

    private static final String TAG = "FragmentTopRated";
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mMoviesView = getView().findViewById(R.id.movies_list2);
        ...
        getView().findViewById(R.id.progress_bar2).setVisibility(View.VISIBLE);
        ...
        if (getActivity().getIntent().hasExtra("genre_id")) {
            mLoader.loadTopRatedMovies(Integer.parseInt(getActivity().getIntent().getStringExtra("genre_id")), language);
        } else {

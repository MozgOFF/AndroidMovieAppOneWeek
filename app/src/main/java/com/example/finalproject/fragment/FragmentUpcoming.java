...
public class FragmentUpcoming extends Fragment implements MoviesLoader.MovieLoadCallback {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mMoviesView = getView().findViewById(R.id.movies_list3);
        ...
        getView().findViewById(R.id.progress_bar3).setVisibility(View.VISIBLE);
        ...
        if (getActivity().getIntent().hasExtra("genre_id")) {
            mLoader.loadUpcomingMovies(Integer.parseInt(getActivity().getIntent().getStringExtra("genre_id")), language);
        } else {
            mLoader.loadUpcomingMovies(0, language);
        }
    }
